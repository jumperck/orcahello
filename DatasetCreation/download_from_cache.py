    ...
    with ThreadPoolExecutor(max_workers=workers) as executor:
        futures = [
            executor.submit(
                ...
                download_wav, download_spectrogram, categories, dry_run,
            )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--month", type=str, help="Single month (YYYY-MM). Default: last month")
    parser.add_argument("--from-month", type=str, help="Start month for range (YYYY-MM)")
    parser.add_argument("--to-month", type=str, help="End month for range (YYYY-MM)")
